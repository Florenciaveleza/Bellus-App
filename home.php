      ...
      <section class="container-fluid" id="hero">
        <div class="row d-flex align-items-center mx-auto ms-2">
          <div class="col-md-6 col-12 mt-5 hero-text d-flex align-items-center">
            <div>
              <h1>
                No existen pieles perfectas, <br />
                existen pieles sanas.
              </h1>
              <p>Encontrá los mejores productos para tu piel.</p>
              <button class="btn-main">
                <a href="public/views/template/catalogo.php">Comprar</a>
              </button>
            </div>
          </div>
          <div class="col-md-6 col-12 mt-5 d-flex justify-content-center">
            <img
              src="public/views/assets/img/hero.png"
      ...
      <div class="container m-5">
        <div class="row">
          <div class="col-sm-12 col-lg-6 d-flex justify-content-center">
            <img
              src="public/views/assets/img/Foto-sobre-nosotros.png"
              alt=""
              class="img-fluid img-sm"
            />
          </div>
          <div
            class="col-sm-12 col-lg-6 d-flex align-items-center mt-5 d-flex justify-content-center"
          >
            <div>
              <h2>Consejos</h2>
              <p>
                Encontrá tu rutina ideal según tu tipo de piel. Vas a poder leer
                los mejores consejos por expertos. Hace de tu cuidado personal
                una prioridad.
              </p>
              <a
                href="public/views/template/consejos.php"
